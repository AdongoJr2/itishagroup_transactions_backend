...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsTransactionController_sendMoney: Record<string, TsoaRoute.ParameterSchema> = {
                sendMoneyDto: {"in":"body","name":"sendMoneyDto","required":true,"ref":"SendMoneyDto"},
        ...
        app.post('/transactions',
            ...
            async function TransactionController_sendMoney(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTransactionController_sendMoney, request, response });
